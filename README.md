...
🔥 Go to [branch 19](https://github.com/Angular-Moderno/ActivityBookings/tree/19) to see 🚀 upgraded version to Angular 1️⃣9️⃣

```bash
# clone lab from github
git clone https://github.com/Angular-Moderno/ActivityBookings.git
# install and run
cd ActivityBookings
npm install
